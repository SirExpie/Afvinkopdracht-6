...
def createHtml (gc_perc,sequence):
    ...
    gc_perc = str(gc_perc)
    html_file.write("Afvinkopdracht 6 <p>" )
    html_file.write("Dit is het gevonden gc percentage: <br>")
    html_file.write(gc_perc + "% <br>")
    html_file.write("Dit is de gevonden sequentie: <br>")
